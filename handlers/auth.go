...
// 				return
// 			}
// 			// Generate a random username if it already exists
// 			username, err = generateRandomUsername(githubUser.Name)
// 			if err != nil {
...
// 		utils.RenderTemplate(w, "templates/username_conflict.html", map[string]interface{}{
// 			"BaseUsername":      githubUser.Name,
// 			"SuggestedUsername": username,
// 			"Email":             githubUser.Email,
// 			"IconURL":           githubUser.Picture,
// 		})
// 		return // Important to return here to prevent executing the rest of the code
// 	}
